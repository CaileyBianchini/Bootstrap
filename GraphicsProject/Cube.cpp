...
Cube::Vertex* Cube::generateVertices(unsigned int& vertexCount)
{
	...
	setVertexPosition(vertices, vertexCount, 3, { -1.0, -1.0f,  1.0f }); //D
	setVertexPosition(vertices, vertexCount, 4, {  1.0,  1.0f, -1.0f }); //E
	setVertexPosition(vertices, vertexCount, 5, { -1.0,  1.0f,  1.0f }); //F
	setVertexPosition(vertices, vertexCount, 6, { -1.0, -1.0f, -1.0f }); //G
	setVertexPosition(vertices, vertexCount, 7, {  1.0, -1.0f,  1.0f }); //H
